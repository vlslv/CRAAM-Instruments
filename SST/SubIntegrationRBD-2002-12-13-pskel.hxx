...
#ifndef SUB_INTEGRATION_RBD_2002_12_13_PSKEL_HXX
#define SUB_INTEGRATION_RBD_2002_12_13_PSKEL_HXX
...
//
class SubIntegrationRecord_pskel;
...
class SubIntegrationRecord_pskel: public ::xml_schema::complex_content
{
  public:
  ...
  //
  void
  time_parser (::xml_schema::int_pskel&);

  void
  adcval0_parser (::xml_schema::unsigned_short_pskel&);

  void
  adcval1_parser (::xml_schema::unsigned_short_pskel&);

  void
  adcval2_parser (::xml_schema::unsigned_short_pskel&);

  void
  adcval3_parser (::xml_schema::unsigned_short_pskel&);

  void
  adcval4_parser (::xml_schema::unsigned_short_pskel&);

  void
  adcval5_parser (::xml_schema::unsigned_short_pskel&);

  void
  pos_time_parser (::xml_schema::int_pskel&);

  void
  azipos_parser (::xml_schema::int_pskel&);

  void
  elepos_parser (::xml_schema::int_pskel&);

  void
  pm_daz_parser (::xml_schema::short_pskel&);

  void
  pm_del_parser (::xml_schema::short_pskel&);

  void
  azierr_parser (::xml_schema::int_pskel&);

  void
  eleerr_parser (::xml_schema::int_pskel&);

  void
  x_off_parser (::xml_schema::short_pskel&);

  void
  y_off_parser (::xml_schema::short_pskel&);

  void
  off0_parser (::xml_schema::short_pskel&);

  void
  off1_parser (::xml_schema::short_pskel&);

  void
  off2_parser (::xml_schema::short_pskel&);

  void
  off3_parser (::xml_schema::short_pskel&);

  void
  off4_parser (::xml_schema::short_pskel&);

  void
  off5_parser (::xml_schema::short_pskel&);

  void
  target_parser (::xml_schema::byte_pskel&);

  void
  opmode_parser (::xml_schema::byte_pskel&);

  void
  gps_status_parser (::xml_schema::short_pskel&);

  void
  recnum_parser (::xml_schema::int_pskel&);
  ...
  protected:
  ::xml_schema::int_pskel* time_parser_;
  ::xml_schema::unsigned_short_pskel* adcval0_parser_;
  ::xml_schema::unsigned_short_pskel* adcval1_parser_;
  ::xml_schema::unsigned_short_pskel* adcval2_parser_;
  ::xml_schema::unsigned_short_pskel* adcval3_parser_;
  ::xml_schema::unsigned_short_pskel* adcval4_parser_;
  ::xml_schema::unsigned_short_pskel* adcval5_parser_;
  ::xml_schema::int_pskel* pos_time_parser_;
  ::xml_schema::int_pskel* azipos_parser_;
  ::xml_schema::int_pskel* elepos_parser_;
  ::xml_schema::short_pskel* pm_daz_parser_;
  ::xml_schema::short_pskel* pm_del_parser_;
  ::xml_schema::int_pskel* azierr_parser_;
  ::xml_schema::int_pskel* eleerr_parser_;
  ::xml_schema::short_pskel* x_off_parser_;
  ::xml_schema::short_pskel* y_off_parser_;
  ::xml_schema::short_pskel* off0_parser_;
  ::xml_schema::short_pskel* off1_parser_;
  ::xml_schema::short_pskel* off2_parser_;
  ::xml_schema::short_pskel* off3_parser_;
  ::xml_schema::short_pskel* off4_parser_;
  ::xml_schema::short_pskel* off5_parser_;
  ::xml_schema::byte_pskel* target_parser_;
  ::xml_schema::byte_pskel* opmode_parser_;
  ::xml_schema::short_pskel* gps_status_parser_;
  ::xml_schema::int_pskel* recnum_parser_;

  protected:
  struct v_state_descr_
  {
    void (::SubIntegrationRecord_pskel::*func) (
      unsigned long&,
      unsigned long&,
      const ::xml_schema::ro_string&,
      const ::xml_schema::ro_string&,
...
#endif // SUB_INTEGRATION_RBD_2002_12_13_PSKEL_HXX
